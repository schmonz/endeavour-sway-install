...
@test "probe_lid_events: chromebook-100e sets HAS_LID_EVENTS=false" {
...
@test "probe_lid_events: thinkpad-x270 leaves HAS_LID_EVENTS=true" {
...
@test "probe_lid_events: macbookair-71 leaves HAS_LID_EVENTS=true" {
